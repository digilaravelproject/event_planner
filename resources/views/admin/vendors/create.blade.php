...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-2 text-sm text-slate-500 font-semibold">
        ...
        <span class="text-slate-800">Add Vendor</span>
    </div>

    <div>
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Create Vendor Profile</h1>
        <p class="text-sm text-slate-500 mt-1">Register a new vendor business listing into the SaaS registry with unified location and venue profiles.</p>
    ...
    <div class="rounded-2xl bg-white p-6 sm:p-8 shadow-sm ring-1 ring-slate-100">
        <form action="{{ route('admin.vendors.store') }}" method="POST" class="space-y-6">
            ...
            <div class="border-b border-slate-100 pb-3">
                <h3 class="text-sm font-bold text-blue-600 uppercase tracking-wider">1. Owner Details</h3>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('name') border-rose-500 bg-rose-50/10 @enderror">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('email') border-rose-500 bg-rose-50/10 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}" required placeholder="e.g. +91 99999 88888"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('phone') border-rose-500 bg-rose-50/10 @enderror">
                ...
                <div>
                    ...
                    <input type="password" name="password" id="password" required placeholder="••••••••"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('password') border-rose-500 bg-rose-50/10 @enderror">
            ...
            <div class="border-b border-slate-100 pb-3 pt-4">
                <h3 class="text-sm font-bold text-blue-600 uppercase tracking-wider">2. Business Brand & Location</h3>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="business_name" id="business_name" value="{{ old('business_name') }}" required
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('business_name') border-rose-500 bg-rose-50/10 @enderror">
            ...
            <div class="border-b border-slate-100 pb-3 pt-4">
                <h3 class="text-sm font-bold text-blue-600 uppercase tracking-wider">3. Venue & Pricing Details</h3>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="venue_name" id="venue_name" value="{{ old('venue_name') }}" required placeholder="e.g. Royal Crystal Palace"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('venue_name') border-rose-500 bg-rose-50/10 @enderror">
                ...
                <div>
                    ...
                    <input type="number" name="venue_capacity" id="venue_capacity" value="{{ old('venue_capacity', '100') }}" required min="1"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('venue_capacity') border-rose-500 bg-rose-50/10 @enderror">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="base_price" id="base_price" value="{{ old('base_price', '0.00') }}" required
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('base_price') border-rose-500 bg-rose-50/10 @enderror">
                    @error('base_price') <p class="text-xs text-rose-500 mt-1.5 font-medium">{{ $message }}</p> @enderror
                </div>

                <!-- Rating -->
                <div>
                    <label for="rating" class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Initial Rating (0.0 to 5.0)</label>
                    <input type="number" step="0.1" min="0" max="5" name="rating" id="rating" value="{{ old('rating', '5.0') }}"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('rating') border-rose-500 bg-rose-50/10 @enderror">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" placeholder="Brief explanation of services, portfolios, and themes..."
                    class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all @error('description') border-rose-500 bg-rose-50/10 @enderror">{{ old('description') }}</textarea>
            ...
            <div class="flex items-center">
                ...
                <label for="status" class="ml-2.5 text-sm font-semibold text-slate-700 select-none cursor-pointer">Mark as Active Listing immediately</label>
            </div>

            <!-- Form Actions -->
            <div class="flex items-center justify-end gap-3.5 border-t border-slate-100 pt-6">
                <a href="{{ route('admin.vendors.index') }}" class="rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-600 text-sm font-semibold px-5 py-2.5 transition">
                    Cancel
                </a>
