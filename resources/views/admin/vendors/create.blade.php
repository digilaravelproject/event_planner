...
<div class="max-w-4xl mx-auto space-y-6 mt-6 relative z-30">
    ...
    <div class="flex items-center gap-2 text-sm text-slate-400 font-semibold">
        ...
        <span class="text-slate-700">Add Vendor</span>
    </div>

    <div>
        <h1 class="text-3xl font-extrabold text-slate-800 tracking-tight">Create Vendor Profile</h1>
        <p class="text-sm text-slate-500 mt-1 font-semibold">Register a new vendor business listing into the SaaS registry with unified location and venue profiles.</p>
        ...
        <form action="{{ route('admin.vendors.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="password" name="password" id="password" required placeholder="••••••••"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#3950a2]/20 focus:border-[#3950a2] transition-all @error('password') border-rose-500 bg-rose-50/10 @enderror">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" placeholder="Brief explanation of services, portfolios, and themes..."
                    class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#3950a2]/20 focus:border-[#3950a2] transition-all @error('description') border-rose-500 bg-rose-50/10 @enderror">{{ old('description') }}</textarea>
