...
class AdminContentSeeder extends Seeder
{
    ...
    private function pages(): array
    {
        return [
            ...
            ['title' => 'Terms and Conditions', 'slug' => 'terms-and-conditions', 'description' => '<h2>Platform terms</h2><p>Vendor pricing, scope, and final service terms must be confirmed directly before booking.</p>', 'status' => true],
